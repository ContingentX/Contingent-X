...
class Controller {
    ...
    function beforeroute() {
        //Api freigeben !public
        if ( $_SERVER["HTTP_HOST"].$_SERVER["REDIRECT_URL"] == $_SERVER["HTTP_HOST"]."/api/user/times")
        {

        }
        elseif ( $this->f3->get( 'SESSION.user' ) === null )
        {
